import { LayoutDashboard, Bot, Zap, Clock, TrendingUp, Brain, Settings, FileText, type LucideIcon } from 'lucide-react';
...
export const navItems: NavItem[] = [
  ...
  { path: '/usage', label: '用量中心', shortLabel: '用量', icon: TrendingUp },
